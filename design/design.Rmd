...
output: Design considerations for the nllocator Package
---
...
Create an R interface to the PDOK Locatieserver API. Locatieserver is a (reverse) geocoding service for The Netherlands.
